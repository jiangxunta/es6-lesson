...
<div class="container">
    ...
    <div class="content markdown-body">
        <p>/*
var name = &apos;zfpx&apos;,age = 8;
let desc = <code>${name} is ${age} old!</code>;
console.log(desc);</p>
<p>*/</p>
<p>/<em>var name = &apos;zfpx&apos;,age = 8;
function desc(strings,...values){
    console.log(strings,values);
}
desc<code>${name} is ${age} old!</code>;</em>/</p>
<p>let desc = &apos;zfpx is 8 years old&apos;;
console.log(desc.endsWith(&apos;old&apos;));
console.log(desc.startsWith(&apos;zfpx&apos;));
console.log(desc.includes(&apos;is&apos;));</p>
